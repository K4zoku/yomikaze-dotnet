...
public partial class YomikazeDbContext
{
    public static partial class Default
    {
        ...
        [
            ...
            new Tag(67464207515254878L, "Adaption", FormatCategory,
                "A comic that is based on a previously existing work."),
            new Tag(67464207515254879L, "Anthology", FormatCategory,
                "A collection of stories or poems by different authors."),
            new Tag(67464207515254880L, "Award Winning", FormatCategory, "A comic that has won an award."),
            new Tag(67464207515254881L, "Doujinshi", FormatCategory,
                "A comic that based on a previously existing work, created by a fan."),
            ...
            new Tag(67464207515254884L, "Long Strip", FormatCategory,
                "A comic that consists of a long strip of panels."),
            new Tag(67464207515254885L, "Official Colored", FormatCategory,
                "A comic that has been officially colored."),
            new Tag(67464207515254886L, "Oneshot", FormatCategory, "A comic that is a single, standalone story."),
            new Tag(67464207515254887L, "Self-Published", FormatCategory,
                "A comic that has been published by the creator."),
