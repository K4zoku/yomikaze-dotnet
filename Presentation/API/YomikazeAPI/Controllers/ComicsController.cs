            ...
            new SearchFieldMutator<Comic, ComicSearchModel>(
                ...
                (query, search) =>
                {
                    ...
                    IOrderedQueryable<Comic> orderedQuery = firstMutator switch
                    {
                        ...
                        ComicOrderBy.LastModified => query.OrderBy(comic => comic.LastModified == null).ThenBy(comic => comic.LastModified), // false is order first so comic with null last modified will be last    
                        ComicOrderBy.LastModifiedDesc => query.OrderBy(comic => comic.LastModified == null).ThenByDescending(comic => comic.LastModified),
                    ...
                    return search.OrderBy!.Skip(1).Aggregate(orderedQuery, (ordered, orderBy) => orderBy switch
                    {
                        ...
                        ComicOrderBy.LastModified => ordered.ThenBy(comic => comic.LastModified == null).ThenBy(comic => comic.LastModified),
                        ComicOrderBy.LastModifiedDesc => ordered.ThenBy(comic => comic.LastModified == null).ThenByDescending(comic => comic.LastModified),
